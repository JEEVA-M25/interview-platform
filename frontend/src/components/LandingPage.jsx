    ...
    >
      ...
      <section className="relative px-6 pt-16 pb-24 md:py-32">
        <div className="max-w-7xl mx-auto grid gap-16 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8 text-center lg:text-left relative z-10">
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-normal text-slate-900 leading-tight">
              Practice Smarter.<br />
              Interview Better.<br />
      ...
      <section className="px-6 py-10 relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="bg-white rounded-[28px] border-2 border-orange-200/50 p-6 md:py-8 shadow-[0_24px_50px_rgba(255,138,61,0.18)] text-center space-y-5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-y-4 gap-x-6 sm:gap-x-8 md:gap-x-10 lg:gap-x-12 opacity-90">
              {/* Google */}
              <div className="flex items-center gap-1.5 font-bold text-slate-850 text-base sm:text-lg hover:opacity-100 transition-opacity">
                ...
                <span className="font-bold tracking-tight text-slate-800">Google</span>
              </div>
              ...
              <div className="flex items-center gap-1.5 font-bold text-slate-850 text-base sm:text-lg hover:opacity-100 transition-opacity">
                ...
                <span className="font-bold tracking-tight text-slate-800">Microsoft</span>
              </div>

              {/* Amazon */}
              <div className="flex flex-col items-center justify-center text-slate-800 hover:opacity-100 transition-opacity">
                <span className="font-extrabold text-base sm:text-lg tracking-tighter lowercase leading-none">amazon</span>
                <svg className="w-12 h-2.5 -mt-0.5 text-[#FF9900]" viewBox="0 0 100 15" fill="none">
              ...
              {/* TCS */}
              <div className="flex items-center gap-1.5 font-bold text-[#002244] text-xs sm:text-sm hover:opacity-100 transition-opacity">
                <span className="text-[#008080] font-black text-base">tcs</span>
                <div className="h-5.5 w-[1.5px] bg-slate-300 mx-1" />
                <span className="text-[10px] text-slate-400 font-bold tracking-tight leading-none uppercase text-left">TATA<br />CONSULTANCY<br />SERVICES</span>
              </div>

              {/* Infosys */}
              <div className="font-bold text-[#006699] text-lg sm:text-xl tracking-wider hover:opacity-100 transition-opacity">
                Infosys
              </div>

              {/* Accenture */}
              <div className="flex items-center gap-0.5 font-bold text-slate-800 text-base sm:text-lg hover:opacity-100 transition-opacity">
                <span className="font-bold tracking-tight">accenture</span>
                <span className="text-[#A12BDF] font-black text-lg">{`>`}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="px-6 py-20 relative bg-[#FFFDF8]">
        ...
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-normal text-slate-900 leading-tight">
              ...
              return (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold tracking-normal text-slate-800">{f.title}</h3>
      ...
      <section id="how-it-works" className="px-6 py-20 relative bg-[#FFFDF8]">
        ...
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          ...
          <div className="text-center max-w-xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-normal text-slate-900">
              How It Works
            </h2>
            ...
            {[
              ...
              <div key={idx} className="text-center space-y-4 flex flex-col items-center">
                ...
                <div className="space-y-1 max-w-[200px]">
                  <h3 className="text-base font-bold tracking-normal text-slate-800">{s.title}</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative rounded-[32px] bg-gradient-to-br from-[#FF8A3D] via-[#7B61FF] to-[#FF7DAE] p-8 md:p-12 overflow-hidden shadow-[0_24px_48px_-12px_rgba(255,138,61,0.4)] flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="space-y-6 relative z-10 text-center md:text-left max-w-xl">
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-normal leading-tight">
