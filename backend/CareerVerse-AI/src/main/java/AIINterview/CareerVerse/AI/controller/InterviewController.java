...
public class InterviewController {
    ...
    /**
     * POST /api/interview/sessions — upload resume + role + difficulty, get back
    ...
    /**
     * GET /api/interview/sessions — all past sessions for the logged-in user
     * (history + resume)
     */
    @GetMapping("/sessions")
    ...
    /**
     * POST /api/interview/sessions/{sessionId}/answers — submit transcript, get
     ...
     * Student corrects speech recognition mistakes before the final report is
     * generated.
     */
    ...
    /**
     * POST /api/interview/sessions/{sessionId}/end — ends interview, returns full
     * scored report
     */
    ...
    /**
     * POST /api/interview/sessions/{sessionId}/proctor-logs — dynamic violation
     * logging
     */
    ...
    /**
     * GET /api/interview/sessions/{sessionId}/report — fetch report for a completed
     * session
     */
